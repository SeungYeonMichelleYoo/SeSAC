 ...
 */
/*
 권한: 반영이 조금씩 느릴 수 있음. 지웠다가 실행한다고 하더라도.
 설정: 앱이 바로 안 뜨는 경우도 있을 수 있음. 뜨는 사람은 설쩡 쪽에서 다음 번에 묻기로 변경
 */
...
//        checkUserDeviceLocationServiceAuthorization() 제거 가능한 이유 명확히 알기!
        ...
        //애플 지도에서 ... 클릭하고 좌표복사하면 위도, 경도 값이 나온다. 밑에 붙여넣기하면 됨
