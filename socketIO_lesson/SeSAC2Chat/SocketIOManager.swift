...
//  SeSAC2Chat
//
//  Created by SeungYeon Yoo on 2022/11/23.
//
...
class SocketIOManager {
    ...
    private init() {
        ...
        socket.on("sesac") { dataArray, ack in
            ...
            NotificationCenter.default.post(name: NSNotification.Name("getMessage"), object: self, userInfo: ["chat": chat, "name": name, "userId": userId, "createdAt": createdAt])
        }
    }
