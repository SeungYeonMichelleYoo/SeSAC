...
class SignupView: BaseView {
    ...
    override func configureUI() {
        [userNameLabel, usernameTextField, emailLabel, emailTextField, passwordLabel, passwordTextField, okButton].forEach {
            self.addSubview($0)
        }
    }
    ...
    override func setConstraints() {
        ...
        okButton.snp.makeConstraints { make in
            make.top.equalTo(passwordLabel.snp.bottom).offset(35)
            make.leading.equalTo(self.safeAreaLayoutGuide).inset(20)
        }
    }
